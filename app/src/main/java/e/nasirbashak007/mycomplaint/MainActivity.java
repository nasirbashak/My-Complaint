...
public class MainActivity extends AppCompatActivity
    ...
    public void submit(View view) {
        ...
        Notification notify=new Notification.Builder
                (getApplicationContext()).setContentTitle("heyy").setContentText("hello").
                setContentTitle(subject).setSmallIcon(R.drawable.common_google_signin_btn_text_dark_normal).build();
